...
#if defined TEST_VECTOR_canonicalize && TEST_VECTOR_canonicalize
# define HAVE_VECTOR_canonicalize 1
# define canonicalize_VEC_SUFF WRAPPER_NAME (canonicalize)
WRAPPER_DECL (WRAPPER_NAME (canonicalize))
#else
# define HAVE_VECTOR_canonicalize 0
# define canonicalize_VEC_SUFF canonicalize
#endif

#if defined TEST_VECTOR_canonicalizef && TEST_VECTOR_canonicalizef
# define HAVE_VECTOR_canonicalizef 1
# define canonicalizef_VEC_SUFF WRAPPER_NAME (canonicalizef)
WRAPPER_DECL (WRAPPER_NAME (canonicalizef))
#else
# define HAVE_VECTOR_canonicalizef 0
# define canonicalizef_VEC_SUFF canonicalizef
#endif

#if defined TEST_VECTOR_canonicalizel && TEST_VECTOR_canonicalizel
# define HAVE_VECTOR_canonicalizel 1
# define canonicalizel_VEC_SUFF WRAPPER_NAME (canonicalizel)
WRAPPER_DECL (WRAPPER_NAME (canonicalizel))
#else
# define HAVE_VECTOR_canonicalizel 0
# define canonicalizel_VEC_SUFF canonicalizel
#endif
...
#if defined TEST_VECTOR_fromfp && TEST_VECTOR_fromfp
# define HAVE_VECTOR_fromfp 1
# define fromfp_VEC_SUFF WRAPPER_NAME (fromfp)
WRAPPER_DECL (WRAPPER_NAME (fromfp))
#else
# define HAVE_VECTOR_fromfp 0
# define fromfp_VEC_SUFF fromfp
#endif

#if defined TEST_VECTOR_fromfpf && TEST_VECTOR_fromfpf
# define HAVE_VECTOR_fromfpf 1
# define fromfpf_VEC_SUFF WRAPPER_NAME (fromfpf)
WRAPPER_DECL (WRAPPER_NAME (fromfpf))
#else
# define HAVE_VECTOR_fromfpf 0
# define fromfpf_VEC_SUFF fromfpf
#endif

#if defined TEST_VECTOR_fromfpl && TEST_VECTOR_fromfpl
# define HAVE_VECTOR_fromfpl 1
# define fromfpl_VEC_SUFF WRAPPER_NAME (fromfpl)
WRAPPER_DECL (WRAPPER_NAME (fromfpl))
#else
# define HAVE_VECTOR_fromfpl 0
# define fromfpl_VEC_SUFF fromfpl
#endif

#if defined TEST_VECTOR_fromfpx && TEST_VECTOR_fromfpx
# define HAVE_VECTOR_fromfpx 1
# define fromfpx_VEC_SUFF WRAPPER_NAME (fromfpx)
WRAPPER_DECL (WRAPPER_NAME (fromfpx))
#else
# define HAVE_VECTOR_fromfpx 0
# define fromfpx_VEC_SUFF fromfpx
#endif

#if defined TEST_VECTOR_fromfpxf && TEST_VECTOR_fromfpxf
# define HAVE_VECTOR_fromfpxf 1
# define fromfpxf_VEC_SUFF WRAPPER_NAME (fromfpxf)
WRAPPER_DECL (WRAPPER_NAME (fromfpxf))
#else
# define HAVE_VECTOR_fromfpxf 0
# define fromfpxf_VEC_SUFF fromfpxf
#endif

#if defined TEST_VECTOR_fromfpxl && TEST_VECTOR_fromfpxl
# define HAVE_VECTOR_fromfpxl 1
# define fromfpxl_VEC_SUFF WRAPPER_NAME (fromfpxl)
WRAPPER_DECL (WRAPPER_NAME (fromfpxl))
#else
# define HAVE_VECTOR_fromfpxl 0
# define fromfpxl_VEC_SUFF fromfpxl
#endif

#if defined TEST_VECTOR_getpayload && TEST_VECTOR_getpayload
# define HAVE_VECTOR_getpayload 1
# define getpayload_VEC_SUFF WRAPPER_NAME (getpayload)
WRAPPER_DECL (WRAPPER_NAME (getpayload))
#else
# define HAVE_VECTOR_getpayload 0
# define getpayload_VEC_SUFF getpayload
#endif

#if defined TEST_VECTOR_getpayloadf && TEST_VECTOR_getpayloadf
# define HAVE_VECTOR_getpayloadf 1
# define getpayloadf_VEC_SUFF WRAPPER_NAME (getpayloadf)
WRAPPER_DECL (WRAPPER_NAME (getpayloadf))
#else
# define HAVE_VECTOR_getpayloadf 0
# define getpayloadf_VEC_SUFF getpayloadf
#endif

#if defined TEST_VECTOR_getpayloadl && TEST_VECTOR_getpayloadl
# define HAVE_VECTOR_getpayloadl 1
# define getpayloadl_VEC_SUFF WRAPPER_NAME (getpayloadl)
WRAPPER_DECL (WRAPPER_NAME (getpayloadl))
#else
# define HAVE_VECTOR_getpayloadl 0
# define getpayloadl_VEC_SUFF getpayloadl
#endif
...
#if defined TEST_VECTOR_iscanonical && TEST_VECTOR_iscanonical
# define HAVE_VECTOR_iscanonical 1
# define iscanonical_VEC_SUFF WRAPPER_NAME (iscanonical)
WRAPPER_DECL (WRAPPER_NAME (iscanonical))
#else
# define HAVE_VECTOR_iscanonical 0
# define iscanonical_VEC_SUFF iscanonical
#endif

#if defined TEST_VECTOR_iscanonicalf && TEST_VECTOR_iscanonicalf
# define HAVE_VECTOR_iscanonicalf 1
# define iscanonicalf_VEC_SUFF WRAPPER_NAME (iscanonicalf)
WRAPPER_DECL (WRAPPER_NAME (iscanonicalf))
#else
# define HAVE_VECTOR_iscanonicalf 0
# define iscanonicalf_VEC_SUFF iscanonicalf
#endif

#if defined TEST_VECTOR_iscanonicall && TEST_VECTOR_iscanonicall
# define HAVE_VECTOR_iscanonicall 1
# define iscanonicall_VEC_SUFF WRAPPER_NAME (iscanonicall)
WRAPPER_DECL (WRAPPER_NAME (iscanonicall))
#else
# define HAVE_VECTOR_iscanonicall 0
# define iscanonicall_VEC_SUFF iscanonicall
#endif

#if defined TEST_VECTOR_iseqsig && TEST_VECTOR_iseqsig
# define HAVE_VECTOR_iseqsig 1
# define iseqsig_VEC_SUFF WRAPPER_NAME (iseqsig)
WRAPPER_DECL (WRAPPER_NAME (iseqsig))
#else
# define HAVE_VECTOR_iseqsig 0
# define iseqsig_VEC_SUFF iseqsig
#endif

#if defined TEST_VECTOR_iseqsigf && TEST_VECTOR_iseqsigf
# define HAVE_VECTOR_iseqsigf 1
# define iseqsigf_VEC_SUFF WRAPPER_NAME (iseqsigf)
WRAPPER_DECL (WRAPPER_NAME (iseqsigf))
#else
# define HAVE_VECTOR_iseqsigf 0
# define iseqsigf_VEC_SUFF iseqsigf
#endif

#if defined TEST_VECTOR_iseqsigl && TEST_VECTOR_iseqsigl
# define HAVE_VECTOR_iseqsigl 1
# define iseqsigl_VEC_SUFF WRAPPER_NAME (iseqsigl)
WRAPPER_DECL (WRAPPER_NAME (iseqsigl))
#else
# define HAVE_VECTOR_iseqsigl 0
# define iseqsigl_VEC_SUFF iseqsigl
#endif
...
#if defined TEST_VECTOR_issubnormal && TEST_VECTOR_issubnormal
# define HAVE_VECTOR_issubnormal 1
# define issubnormal_VEC_SUFF WRAPPER_NAME (issubnormal)
WRAPPER_DECL (WRAPPER_NAME (issubnormal))
#else
# define HAVE_VECTOR_issubnormal 0
# define issubnormal_VEC_SUFF issubnormal
#endif

#if defined TEST_VECTOR_issubnormalf && TEST_VECTOR_issubnormalf
# define HAVE_VECTOR_issubnormalf 1
# define issubnormalf_VEC_SUFF WRAPPER_NAME (issubnormalf)
WRAPPER_DECL (WRAPPER_NAME (issubnormalf))
#else
# define HAVE_VECTOR_issubnormalf 0
# define issubnormalf_VEC_SUFF issubnormalf
#endif

#if defined TEST_VECTOR_issubnormall && TEST_VECTOR_issubnormall
# define HAVE_VECTOR_issubnormall 1
# define issubnormall_VEC_SUFF WRAPPER_NAME (issubnormall)
WRAPPER_DECL (WRAPPER_NAME (issubnormall))
#else
# define HAVE_VECTOR_issubnormall 0
# define issubnormall_VEC_SUFF issubnormall
#endif
...
#if defined TEST_VECTOR_iszero && TEST_VECTOR_iszero
# define HAVE_VECTOR_iszero 1
# define iszero_VEC_SUFF WRAPPER_NAME (iszero)
WRAPPER_DECL (WRAPPER_NAME (iszero))
#else
# define HAVE_VECTOR_iszero 0
# define iszero_VEC_SUFF iszero
#endif

#if defined TEST_VECTOR_iszerof && TEST_VECTOR_iszerof
# define HAVE_VECTOR_iszerof 1
# define iszerof_VEC_SUFF WRAPPER_NAME (iszerof)
WRAPPER_DECL (WRAPPER_NAME (iszerof))
#else
# define HAVE_VECTOR_iszerof 0
# define iszerof_VEC_SUFF iszerof
#endif

#if defined TEST_VECTOR_iszerol && TEST_VECTOR_iszerol
# define HAVE_VECTOR_iszerol 1
# define iszerol_VEC_SUFF WRAPPER_NAME (iszerol)
WRAPPER_DECL (WRAPPER_NAME (iszerol))
#else
# define HAVE_VECTOR_iszerol 0
# define iszerol_VEC_SUFF iszerol
#endif
...
#if defined TEST_VECTOR_llogb && TEST_VECTOR_llogb
# define HAVE_VECTOR_llogb 1
# define llogb_VEC_SUFF WRAPPER_NAME (llogb)
WRAPPER_DECL (WRAPPER_NAME (llogb))
#else
# define HAVE_VECTOR_llogb 0
# define llogb_VEC_SUFF llogb
#endif

#if defined TEST_VECTOR_llogbf && TEST_VECTOR_llogbf
# define HAVE_VECTOR_llogbf 1
# define llogbf_VEC_SUFF WRAPPER_NAME (llogbf)
WRAPPER_DECL (WRAPPER_NAME (llogbf))
#else
# define HAVE_VECTOR_llogbf 0
# define llogbf_VEC_SUFF llogbf
#endif

#if defined TEST_VECTOR_llogbl && TEST_VECTOR_llogbl
# define HAVE_VECTOR_llogbl 1
# define llogbl_VEC_SUFF WRAPPER_NAME (llogbl)
WRAPPER_DECL (WRAPPER_NAME (llogbl))
#else
# define HAVE_VECTOR_llogbl 0
# define llogbl_VEC_SUFF llogbl
#endif
...
#if defined TEST_VECTOR_nextup && TEST_VECTOR_nextup
# define HAVE_VECTOR_nextup 1
# define nextup_VEC_SUFF WRAPPER_NAME (nextup)
WRAPPER_DECL (WRAPPER_NAME (nextup))
#else
# define HAVE_VECTOR_nextup 0
# define nextup_VEC_SUFF nextup
#endif

#if defined TEST_VECTOR_nextupf && TEST_VECTOR_nextupf
# define HAVE_VECTOR_nextupf 1
# define nextupf_VEC_SUFF WRAPPER_NAME (nextupf)
WRAPPER_DECL (WRAPPER_NAME (nextupf))
#else
# define HAVE_VECTOR_nextupf 0
# define nextupf_VEC_SUFF nextupf
#endif

#if defined TEST_VECTOR_nextupl && TEST_VECTOR_nextupl
# define HAVE_VECTOR_nextupl 1
# define nextupl_VEC_SUFF WRAPPER_NAME (nextupl)
WRAPPER_DECL (WRAPPER_NAME (nextupl))
#else
# define HAVE_VECTOR_nextupl 0
# define nextupl_VEC_SUFF nextupl
#endif

#if defined TEST_VECTOR_nextdown && TEST_VECTOR_nextdown
# define HAVE_VECTOR_nextdown 1
# define nextdown_VEC_SUFF WRAPPER_NAME (nextdown)
WRAPPER_DECL (WRAPPER_NAME (nextdown))
#else
# define HAVE_VECTOR_nextdown 0
# define nextdown_VEC_SUFF nextdown
#endif

#if defined TEST_VECTOR_nextdownf && TEST_VECTOR_nextdownf
# define HAVE_VECTOR_nextdownf 1
# define nextdownf_VEC_SUFF WRAPPER_NAME (nextdownf)
WRAPPER_DECL (WRAPPER_NAME (nextdownf))
#else
# define HAVE_VECTOR_nextdownf 0
# define nextdownf_VEC_SUFF nextdownf
#endif

#if defined TEST_VECTOR_nextdownl && TEST_VECTOR_nextdownl
# define HAVE_VECTOR_nextdownl 1
# define nextdownl_VEC_SUFF WRAPPER_NAME (nextdownl)
WRAPPER_DECL (WRAPPER_NAME (nextdownl))
#else
# define HAVE_VECTOR_nextdownl 0
# define nextdownl_VEC_SUFF nextdownl
#endif
...
WRAPPER_DECL (WRAPPER_NAME (nexttoward))
#else
...
WRAPPER_DECL (WRAPPER_NAME (nexttowardf))
#else
...
WRAPPER_DECL (WRAPPER_NAME (nexttowardl))
#else
...
#if defined TEST_VECTOR_roundeven && TEST_VECTOR_roundeven
# define HAVE_VECTOR_roundeven 1
# define roundeven_VEC_SUFF WRAPPER_NAME (roundeven)
WRAPPER_DECL (WRAPPER_NAME (roundeven))
#else
# define HAVE_VECTOR_roundeven 0
# define roundeven_VEC_SUFF roundeven
#endif

#if defined TEST_VECTOR_roundevenf && TEST_VECTOR_roundevenf
# define HAVE_VECTOR_roundevenf 1
# define roundevenf_VEC_SUFF WRAPPER_NAME (roundevenf)
WRAPPER_DECL (WRAPPER_NAME (roundevenf))
#else
# define HAVE_VECTOR_roundevenf 0
# define roundevenf_VEC_SUFF roundevenf
#endif

#if defined TEST_VECTOR_roundevenl && TEST_VECTOR_roundevenl
# define HAVE_VECTOR_roundevenl 1
# define roundevenl_VEC_SUFF WRAPPER_NAME (roundevenl)
WRAPPER_DECL (WRAPPER_NAME (roundevenl))
#else
# define HAVE_VECTOR_roundevenl 0
# define roundevenl_VEC_SUFF roundevenl
#endif
...
#if defined TEST_VECTOR_setpayload && TEST_VECTOR_setpayload
# define HAVE_VECTOR_setpayload 1
# define setpayload_VEC_SUFF WRAPPER_NAME (setpayload)
WRAPPER_DECL (WRAPPER_NAME (setpayload))
#else
# define HAVE_VECTOR_setpayload 0
# define setpayload_VEC_SUFF setpayload
#endif

#if defined TEST_VECTOR_setpayloadf && TEST_VECTOR_setpayloadf
# define HAVE_VECTOR_setpayloadf 1
# define setpayloadf_VEC_SUFF WRAPPER_NAME (setpayloadf)
WRAPPER_DECL (WRAPPER_NAME (setpayloadf))
#else
# define HAVE_VECTOR_setpayloadf 0
# define setpayloadf_VEC_SUFF setpayloadf
#endif

#if defined TEST_VECTOR_setpayloadl && TEST_VECTOR_setpayloadl
# define HAVE_VECTOR_setpayloadl 1
# define setpayloadl_VEC_SUFF WRAPPER_NAME (setpayloadl)
WRAPPER_DECL (WRAPPER_NAME (setpayloadl))
#else
# define HAVE_VECTOR_setpayloadl 0
# define setpayloadl_VEC_SUFF setpayloadl
#endif

#if defined TEST_VECTOR_setpayloadsig && TEST_VECTOR_setpayloadsig
# define HAVE_VECTOR_setpayloadsig 1
# define setpayloadsig_VEC_SUFF WRAPPER_NAME (setpayloadsig)
WRAPPER_DECL (WRAPPER_NAME (setpayloadsig))
#else
# define HAVE_VECTOR_setpayloadsig 0
# define setpayloadsig_VEC_SUFF setpayloadsig
#endif

#if defined TEST_VECTOR_setpayloadsigf && TEST_VECTOR_setpayloadsigf
# define HAVE_VECTOR_setpayloadsigf 1
# define setpayloadsigf_VEC_SUFF WRAPPER_NAME (setpayloadsigf)
WRAPPER_DECL (WRAPPER_NAME (setpayloadsigf))
#else
# define HAVE_VECTOR_setpayloadsigf 0
# define setpayloadsigf_VEC_SUFF setpayloadsigf
#endif

#if defined TEST_VECTOR_setpayloadsigl && TEST_VECTOR_setpayloadsigl
# define HAVE_VECTOR_setpayloadsigl 1
# define setpayloadsigl_VEC_SUFF WRAPPER_NAME (setpayloadsigl)
WRAPPER_DECL (WRAPPER_NAME (setpayloadsigl))
#else
# define HAVE_VECTOR_setpayloadsigl 0
# define setpayloadsigl_VEC_SUFF setpayloadsigl
#endif
...
#if defined TEST_VECTOR_totalorder && TEST_VECTOR_totalorder
# define HAVE_VECTOR_totalorder 1
# define totalorder_VEC_SUFF WRAPPER_NAME (totalorder)
WRAPPER_DECL (WRAPPER_NAME (totalorder))
#else
# define HAVE_VECTOR_totalorder 0
# define totalorder_VEC_SUFF totalorder
#endif

#if defined TEST_VECTOR_totalorderf && TEST_VECTOR_totalorderf
# define HAVE_VECTOR_totalorderf 1
# define totalorderf_VEC_SUFF WRAPPER_NAME (totalorderf)
WRAPPER_DECL (WRAPPER_NAME (totalorderf))
#else
# define HAVE_VECTOR_totalorderf 0
# define totalorderf_VEC_SUFF totalorderf
#endif

#if defined TEST_VECTOR_totalorderl && TEST_VECTOR_totalorderl
# define HAVE_VECTOR_totalorderl 1
# define totalorderl_VEC_SUFF WRAPPER_NAME (totalorderl)
WRAPPER_DECL (WRAPPER_NAME (totalorderl))
#else
# define HAVE_VECTOR_totalorderl 0
# define totalorderl_VEC_SUFF totalorderl
#endif

#if defined TEST_VECTOR_totalordermag && TEST_VECTOR_totalordermag
# define HAVE_VECTOR_totalordermag 1
# define totalordermag_VEC_SUFF WRAPPER_NAME (totalordermag)
WRAPPER_DECL (WRAPPER_NAME (totalordermag))
#else
# define HAVE_VECTOR_totalordermag 0
# define totalordermag_VEC_SUFF totalordermag
#endif

#if defined TEST_VECTOR_totalordermagf && TEST_VECTOR_totalordermagf
# define HAVE_VECTOR_totalordermagf 1
# define totalordermagf_VEC_SUFF WRAPPER_NAME (totalordermagf)
WRAPPER_DECL (WRAPPER_NAME (totalordermagf))
#else
# define HAVE_VECTOR_totalordermagf 0
# define totalordermagf_VEC_SUFF totalordermagf
#endif

#if defined TEST_VECTOR_totalordermagl && TEST_VECTOR_totalordermagl
# define HAVE_VECTOR_totalordermagl 1
# define totalordermagl_VEC_SUFF WRAPPER_NAME (totalordermagl)
WRAPPER_DECL (WRAPPER_NAME (totalordermagl))
#else
# define HAVE_VECTOR_totalordermagl 0
# define totalordermagl_VEC_SUFF totalordermagl
#endif
...
#if defined TEST_VECTOR_ufromfp && TEST_VECTOR_ufromfp
# define HAVE_VECTOR_ufromfp 1
# define ufromfp_VEC_SUFF WRAPPER_NAME (ufromfp)
WRAPPER_DECL (WRAPPER_NAME (ufromfp))
#else
# define HAVE_VECTOR_ufromfp 0
# define ufromfp_VEC_SUFF ufromfp
#endif

#if defined TEST_VECTOR_ufromfpf && TEST_VECTOR_ufromfpf
# define HAVE_VECTOR_ufromfpf 1
# define ufromfpf_VEC_SUFF WRAPPER_NAME (ufromfpf)
WRAPPER_DECL (WRAPPER_NAME (ufromfpf))
#else
# define HAVE_VECTOR_ufromfpf 0
# define ufromfpf_VEC_SUFF ufromfpf
#endif

#if defined TEST_VECTOR_ufromfpl && TEST_VECTOR_ufromfpl
# define HAVE_VECTOR_ufromfpl 1
# define ufromfpl_VEC_SUFF WRAPPER_NAME (ufromfpl)
WRAPPER_DECL (WRAPPER_NAME (ufromfpl))
#else
# define HAVE_VECTOR_ufromfpl 0
# define ufromfpl_VEC_SUFF ufromfpl
#endif

#if defined TEST_VECTOR_ufromfpx && TEST_VECTOR_ufromfpx
# define HAVE_VECTOR_ufromfpx 1
# define ufromfpx_VEC_SUFF WRAPPER_NAME (ufromfpx)
WRAPPER_DECL (WRAPPER_NAME (ufromfpx))
#else
# define HAVE_VECTOR_ufromfpx 0
# define ufromfpx_VEC_SUFF ufromfpx
#endif

#if defined TEST_VECTOR_ufromfpxf && TEST_VECTOR_ufromfpxf
# define HAVE_VECTOR_ufromfpxf 1
# define ufromfpxf_VEC_SUFF WRAPPER_NAME (ufromfpxf)
WRAPPER_DECL (WRAPPER_NAME (ufromfpxf))
#else
# define HAVE_VECTOR_ufromfpxf 0
# define ufromfpxf_VEC_SUFF ufromfpxf
#endif

#if defined TEST_VECTOR_ufromfpxl && TEST_VECTOR_ufromfpxl
# define HAVE_VECTOR_ufromfpxl 1
# define ufromfpxl_VEC_SUFF WRAPPER_NAME (ufromfpxl)
WRAPPER_DECL (WRAPPER_NAME (ufromfpxl))
#else
# define HAVE_VECTOR_ufromfpxl 0
# define ufromfpxl_VEC_SUFF ufromfpxl
#endif
...
#if defined TEST_VECTOR_fmaxmag && TEST_VECTOR_fmaxmag
# define HAVE_VECTOR_fmaxmag 1
# define fmaxmag_VEC_SUFF WRAPPER_NAME (fmaxmag)
WRAPPER_DECL_ff (WRAPPER_NAME (fmaxmag))
#else
# define HAVE_VECTOR_fmaxmag 0
# define fmaxmag_VEC_SUFF fmaxmag
#endif

#if defined TEST_VECTOR_fmaxmagf && TEST_VECTOR_fmaxmagf
# define HAVE_VECTOR_fmaxmagf 1
# define fmaxmagf_VEC_SUFF WRAPPER_NAME (fmaxmagf)
WRAPPER_DECL_ff (WRAPPER_NAME (fmaxmagf))
#else
# define HAVE_VECTOR_fmaxmagf 0
# define fmaxmagf_VEC_SUFF fmaxmagf
#endif

#if defined TEST_VECTOR_fmaxmagl && TEST_VECTOR_fmaxmagl
# define HAVE_VECTOR_fmaxmagl 1
# define fmaxmagl_VEC_SUFF WRAPPER_NAME (fmaxmagl)
WRAPPER_DECL_ff (WRAPPER_NAME (fmaxmagl))
#else
# define HAVE_VECTOR_fmaxmagl 0
# define fmaxmagl_VEC_SUFF fmaxmagl
#endif
...
#if defined TEST_VECTOR_fminmag && TEST_VECTOR_fminmag
# define HAVE_VECTOR_fminmag 1
# define fminmag_VEC_SUFF WRAPPER_NAME (fminmag)
WRAPPER_DECL_ff (WRAPPER_NAME (fminmag))
#else
# define HAVE_VECTOR_fminmag 0
# define fminmag_VEC_SUFF fminmag
#endif

#if defined TEST_VECTOR_fminmagf && TEST_VECTOR_fminmagf
# define HAVE_VECTOR_fminmagf 1
# define fminmagf_VEC_SUFF WRAPPER_NAME (fminmagf)
WRAPPER_DECL_ff (WRAPPER_NAME (fminmagf))
#else
# define HAVE_VECTOR_fminmagf 0
# define fminmagf_VEC_SUFF fminmagf
#endif

#if defined TEST_VECTOR_fminmagl && TEST_VECTOR_fminmagl
# define HAVE_VECTOR_fminmagl 1
# define fminmagl_VEC_SUFF WRAPPER_NAME (fminmagl)
WRAPPER_DECL_ff (WRAPPER_NAME (fminmagl))
#else
# define HAVE_VECTOR_fminmagl 0
# define fminmagl_VEC_SUFF fminmagl
#endif
